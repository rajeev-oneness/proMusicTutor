...
class CreateSaxSeriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sax_series', function (Blueprint $table) {
            $table->id();
        ...
        $data = [
            [
                ...
                'description' => "Learn from Micky Moody the legendary Whitesnake . In this series Micky 's aim is to pass on ....",
    ...
    {
        Schema::dropIfExists('sax_series');
    }
}
